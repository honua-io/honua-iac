...
output "container_app_name" {
  description = "Azure Container App name for the Honua workload."
  value       = module.honua.container_app_name
}

output "container_app_id" {
  description = "Azure Container App resource ID for the Honua workload."
...
output "control_plane_target_kind" {
  description = "Control-plane target kind emitted by the ACA module."
  value       = module.honua.control_plane_target_kind
}

output "control_plane_backend_name" {
  description = "Control-plane backend name emitted by the ACA module."
  value       = module.honua.control_plane_backend_name
}

output "control_plane_target_id" {
  description = "Control-plane target identifier emitted by the ACA module."
  value       = module.honua.control_plane_target_id
}

output "control_plane_target_name" {
  description = "Control-plane target name emitted by the ACA module."
  value       = module.honua.control_plane_target_name
}

output "control_plane_target_resource_id" {
  description = "Provider resource ID for the Container Apps control-plane target."
  value       = module.honua.control_plane_target_resource_id
}

output "control_plane_target_resource_group" {
  description = "Azure resource group containing the Container Apps target."
  value       = module.honua.control_plane_target_resource_group
}

output "control_plane_telemetry_policy" {
  description = "Telemetry policy advertised by the ACA module."
  value       = module.honua.control_plane_telemetry_policy
}

output "database_fqdn" {
  description = "PostgreSQL FQDN used by the ACA deployment."
