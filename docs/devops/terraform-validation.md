...
|---|---|
| `static-validate` | bootstrap roots, all example roots, all module roots, plus provider-constraint alignment, first-party output description and check-message convention checks, marketplace metadata, and customer distribution packaging checks |
...
- `HONUA_AKS_CLUSTER_ENDPOINT_PUBLIC_ACCESS_CIDR`
- `HONUA_EKS_CLUSTER_ENDPOINT_PUBLIC_ACCESS_CIDR`
